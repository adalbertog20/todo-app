        ...
        {isEmail && (
          <View>
            <TextInput
              ...
              type="text" placeholder="type your email" {...props} />
            {isEmailEmpty ? (<Text className="text-red-600">Field empty</Text>) : (<Text></Text>)}
            {isEmailValid && (
        ...
        {isName && (
          <View>
            <TextInput
              ...
              className="border-b-2 border-blue-400 w-44 h-10 pl-2 m-6 text-lg rounded-md "
              type="text" placeholder="type your name" {...props} />
            <Image
              className="w-6 h-6 absolute left-40 top-8"
              source={require('../assets/user.png')} />
            {isNameEmpty ? (<Text className="text-red-600">Field empty</Text>) : (<Text></Text>)}
            {!isNameValid && (
              <Text className="text-red-600">Field should not contain numbers</Text>)}
          </View>
        )}
        {isPassword && (
          <View>
            <TextInput
              ...
              className="border-b-2 border-blue-400 w-44 h-10 pl-2 m-6 text-lg rounded-md "
              type="text" placeholder="type your password" {...props} />
            <Image
              className="w-6 h-6 absolute left-40 top-8"
              source={require('../assets/pass.png')} />
            {isPasswordValid && (<Text className="text-red-600">password must be at least 8 characters</Text>)}
          </View>
